...
## 🌟 คุณสมบัติ
- **Date Picker:** เลือกวันที่เดินทางได้จากปฏิทิน ไม่ต้องพิมพ์เอง พร้อมปุ่มสลับโหมด 1 วัน / 2 วัน แบบ segmented
- **Clean UI:** หน้าจอออกแบบสไตล์ Minimal โทนขาว-น้ำเงิน สะอาดตา อ่านง่าย
- **สรุปก่อนส่ง:** การ์ดแสดงผู้รับ (To/CC) และวันที่เดินทางแบบไทย อัปเดตสดก่อนกดส่ง
- **แจ้งผลในแอป:** แถบสถานะใต้ปุ่มส่ง (กำลังส่ง / สำเร็จ / ผิดพลาด) พร้อมล็อกปุ่มกันกดส่งซ้ำ
